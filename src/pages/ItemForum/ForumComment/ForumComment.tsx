...
const ForumComment: FC<Props> = ({ right }) => {
  ...
  return (
    <div className={b()}>
      ...
      <div className={b('body', { right })}>
        <div>
          <span className={b('title')}>Gilliam Underwood</span>
          <small>16-03-2021, 11:47</small>
        </div>
        <p>было дело..даже в салон ходил играть</p>
      </div>
      {!right && (
